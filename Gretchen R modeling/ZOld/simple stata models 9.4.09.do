...
mkspline age1_40 40 age2_40 = mage
...
glm count age1_40 age2_40 agelgdp aget sex threshold lgdp [aweight=wght], family(binomial n) 
glm count age2050_* agelgdp aget sex threshold lgdp [aweight=wght], family(binomial n) 
glm count age1_40 age2_40 agelgdp aget sex threshold lgdp age2 th2 [aweight=wght], family(binomial n) 
glm count a0 a5 a10 age1_40 age2_40 agelgdp aget sex threshold lgdp [aweight=wght], family(binomial n) 
pause
...
regress logitprev mage agelgdp aget sex threshold lgdp if prediction == 0 [aweight=wght]
predict olslogit
