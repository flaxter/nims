...
setwd( "D:/Files/GBD/Hearing loss/Gretchen R modeling/")
# preprocess data
source("data_preprocess_gs.R")
# after running this, the odata data frame contains almost all data need for 
# leave one out analysis.  NB: GS took out "samplesize" because she thinks it should not
# be called.  Unclear if this matters?

# initialize code -- this gives a function that runs the model
